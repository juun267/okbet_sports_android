...
//
//
//class OddButtonPagerAdapter(val onOddsClick:(OddsButton2, MatchOdd)-> Unit) :RecyclerView.Adapter<OddButtonPagerViewHolder>() {
...
//        val holder = OddButtonPagerViewHolder(OddBtnList(parent.context), matchOdd, onOddsClick)
//        forTest("OddButtonPagerAdapter onCreateViewHolder 111 耗费：${System.currentTimeMillis() - start}")
//        return holder
//    }
//
...
//            matchType
//        )
//        forTest("OddButtonPagerAdapter onBindViewHolder 222 耗费：${System.currentTimeMillis() - start}")
//    }
//
...
//            val data = last.first()
//            holder.updateOddsButton2(position,
//                itemCount,
//                matchInfo,
//                playCateNameMap,
//                betPlayCateNameMap,
...
//            )
//
//            forTest("OddButtonPagerAdapter onCreateViewHolder 333 耗费：${System.currentTimeMillis() - start}")
//        }
//    }
//
...
//                bindOddClick(oddBtnOther, it, matchOdd = matchOdd, matchInfo, playCateCode, playCateName, betPlayCateName)
//            }
//            return
//        }
//
...
//            bindOddClick(oddBtnHome, it, matchOdd = matchOdd, matchInfo, playCateCode, playCateName, betPlayCateName)
//        }
//
...
//            bindOddClick(oddBtnAway, it, matchOdd = matchOdd, matchInfo, playCateCode, playCateName, betPlayCateName)
//        }
//
...
//            bindOddClick(oddBtnDraw, drawOdd, matchOdd = matchOdd, matchInfo, playCateCode, playCateName, betPlayCateName)
//        } else {
...
//            itemOdd?.let { onOddsClick.invoke(oddsButton, matchOdd) }
//        }
//    }
//
