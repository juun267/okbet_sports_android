...
import org.cxct.sportlottery.databinding.ItemHomeHotEsportChrisBinding
...
class ItemHomeHotESportHolder(
    lifecycleOwner: LifecycleOwner,
    val binding: ItemHomeHotEsportChrisBinding,
...
//        binding.tvGamePlayCateCodeName.text = LocalUtils.getString(R.string.win_line)
    ...
    private fun setOdds(
        currentOddBtn: OddsHomeHotButton,
        otherBtn1: OddsHomeHotButton?,
        otherBtn2: OddsHomeHotButton?,
        odd: Odd?,
     ...
     * 配置投注按鈕Callback
     */
    private fun OddsHomeHotButton.setButtonBetClick(
        data: Recommend,
        odd: Odd?,
        playCateCode: String,
        playCateName: String,
     ...
     * 配置比分及比賽制度
     */
    private fun setupMatchScore(item: Recommend)=binding.run {
...
//                            getRecommendData()[0].runningTime = binding.tvGamePlayTime.text.toString()
    ...
    private fun setupOddsButton(oddsButton: OddsHomeHotButton, odd: Odd?) {
