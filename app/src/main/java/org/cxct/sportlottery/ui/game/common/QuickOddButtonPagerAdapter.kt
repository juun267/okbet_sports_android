...
class QuickOddButtonPagerAdapter :RecyclerView.Adapter<QuickOddButtonPagerViewHolder>() {
    ...
    var listener: QuickOddButtonListener? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuickOddButtonPagerViewHolder {
        return QuickOddButtonPagerViewHolder.from(parent, oddStateRefreshListener)
    }

    override fun onBindViewHolder(holder: QuickOddButtonPagerViewHolder, position: Int) {
    ...
    override fun onBindViewHolder(holder: QuickOddButtonPagerViewHolder, position: Int, payloads: MutableList<Any>) {
...
class QuickOddButtonPagerViewHolder private constructor(
    itemView: View,
    ...
    fun bind(
        ...
        oddsType: OddsType,
        oddButtonListener: QuickOddButtonListener?,
    ) {
        setupOddsButton(
    ...
    private fun <K, V> Map<out K, V>.getPlayCateName(context: Context): String {
    ...
    private fun setupOddsButton(
        ...
        val playCateName =
            playCateNameMap[odds.first]?.getPlayCateName(itemView.context)
                ?.replace(": ", " ")?.replace("||", "\n") ?: ""
        val betPlayCateName =
            betPlayCateNameMap[odds.first]?.getPlayCateName(itemView.context)?.replace(": ", " ")
                ?.replace("||", "\n") ?: ""
...
//                        }
            ...
            this@QuickOddButtonPagerViewHolder.setupOddState(this, odds.second?.getOrNull(0))
...
//                        }
            ...
            this@QuickOddButtonPagerViewHolder.setupOddState(this, odds.second?.getOrNull(1))
        ...
        oddBtnDraw.apply drawButtonSettings@{
            ...
            this@QuickOddButtonPagerViewHolder.setupOddState(this, odds.second?.getOrNull(2))
...
//                        }
    ...
    companion object {
        ...
        ): QuickOddButtonPagerViewHolder {
            val layoutInflater = LayoutInflater.from(parent.context)
            val view = layoutInflater
                .inflate(R.layout.itemview_odd_btn_2x2_v6, parent, false)

            return QuickOddButtonPagerViewHolder(view, oddStateRefreshListener)
        }
    }
}

class QuickOddButtonListener(
