...
class LeagueOddAdapter : RecyclerView.Adapter<LeagueOddAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.bind(item, playType, matchOddListener, itemExpandListener)
    }
    ...
    class ViewHolder private constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: LeagueOdd, playType: PlayType, matchOddListener: MatchOddListener?, itemExpandListener: ItemExpandListener?) {
