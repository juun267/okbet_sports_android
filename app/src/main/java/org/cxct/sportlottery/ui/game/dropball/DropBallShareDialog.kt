...
import org.cxct.sportlottery.databinding.DialogDropBallInviteBinding
...
class DropBallShareDialog: BaseDialog<ProfileModel,DialogDropBallInviteBinding>() {

    init {
        setStyle(R.style.FullScreen)
    }
    companion object{
        fun newInstance(inviteCode: String) = DropBallShareDialog().apply {
            arguments = Bundle().apply { putString("inviteCode", inviteCode) }
        }
    }
    private val inviteUrl = Constants.getPromoDropBall();
    private val quote = "Welcome to OKBet's Drop Ball Game! You can now claim your free ₱20 for visiting us at OKBet.com!"
