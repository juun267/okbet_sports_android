...
import org.cxct.sportlottery.databinding.ItemSportFootGameBinding
...
//            setOnClickListener { moreClick?.invoke() }
    ...
    override fun onBinding(position: Int, binding: ItemSportFootGameBinding, item: OKGameBean) {
        ...
        binding.apply {
            ...
            root.setOnClickListener {
                if (!item.isMaintain()) {
                    getOnItemClickListener()?.onItemClick(this@SportFootGameAdapter, root, position)
                }
            }
    ...
    override fun onBinding(position: Int, binding: ItemSportFootGameBinding, item: OKGameBean, payloads: List<Any>) {
        payloads.forEach {
            if (it == GAME_MAINTAIN) {
