...
class OddsDetailListAdapter(private val onOddClickListener: OnOddClickListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val layout: Int = when (sportCode) {
            ...
            GameType.BM -> {
                when (viewType) {
                    PlayCate.SINGLE.ordinal, PlayCate.SINGLE_SEG1.ordinal, PlayCate.SINGLE_SEG2.ordinal, PlayCate.SINGLE_SEG3.ordinal, PlayCate.HDP.ordinal,PlayCate.HDP_SEG1.ordinal, PlayCate.HDP_SEG2.ordinal, PlayCate.HDP_SEG3.ordinal,
            ...
            GameType.BB -> {
                when (viewType) {
                    ...
                    PlayCate.EXTRA_TIME.ordinal, PlayCate.SINGLE_1ST.ordinal, PlayCate.TG_OU_H.ordinal, PlayCate.TG_OU_C.ordinal -> LayoutType.SINGLE_2_ITEM.layout

                    PlayCate.SINGLE_SEG1.ordinal, PlayCate.SINGLE_1ST.ordinal -> LayoutType.SINGLE.layout
