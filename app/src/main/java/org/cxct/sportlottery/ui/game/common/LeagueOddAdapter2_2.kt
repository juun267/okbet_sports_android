...
//import java.util.*
//
//class LeagueOddAdapter2_2(private val matchType: MatchType) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
//
...
//            setupOddsButton(matchType, item, leagueOddListener)
//
