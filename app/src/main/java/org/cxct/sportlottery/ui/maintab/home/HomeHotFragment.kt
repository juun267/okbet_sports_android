...
class HomeHotFragment : BindingSocketFragment<MainHomeViewModel, FragmentMainHomeBinding>() {
    ...
    override fun onBindViewStatus(view: View) = binding.run {
        homeTopView.setup(this@HomeHotFragment)
...
//        okGamesView.setOkGamesData(this@MainHomeFragment)
        gameViewOkGame.initOkGames(this@HomeHotFragment)
        gameViewOkGame.bindLifecycleOwner(this@HomeHotFragment)
//        if (StaticData.okLiveOpened()){
            gameViewOkLive.initOkLiveList(this@HomeHotFragment)
            gameViewOkLive.bindLifecycleOwner(this@HomeHotFragment)
//        }
        setHalloweenStyle2()
    ...
    fun initToolBar() = binding.run {
        ...
        homeToolbar.attach(this@HomeHotFragment, getMainTabActivity(), viewModel)
