...
//    }
    ...
    private fun initHomeFollowData(){
        ...
        //初始化各个社交按钮
        sConfigData?.let {
            val faceBookMenu= FollowMenuBean(context.getString(R.string.facebookFollow),R.drawable.ic_home_facebook,it.facebookLinkConfig)
            val instagramMenu= FollowMenuBean(context.getString(R.string.instagramFollow),R.drawable.ic_home_ins,it.instagramLinkConfig)
            val youTubeMenu= FollowMenuBean(context.getString(R.string.youtubeFollow),R.drawable.ic_home_youtube,it.youtubeLinkConfig)
            val twitterMenu= FollowMenuBean(context.getString(R.string.twitterFollow),R.drawable.ic_home_twiter,it.twitterLinkConfig)
            val tiktokMenu= FollowMenuBean(context.getString(R.string.tiktokFollow),R.drawable.ic_home_tik,it.tiktokLinkConfig)

            //添加社交按钮
            initListData(faceBookMenu,instagramMenu,youTubeMenu,twitterMenu,tiktokMenu)
