...
object VectorDrawableCreator {
    ...
    private val BIN_XML_ATTRS = intArrayOf(R.attr.height, R.attr.width, R.attr.viewportWidth, R.attr.viewportHeight, R.attr.fillColor, R.attr.pathData)
    ...
    fun getVectorDrawable(
        ...
        try {
            ...
            val parser: XmlPullParser = xmlParserNew.invoke(xmlBlockConstr.newInstance(binXml as Any)) as XmlPullParser
            return if (Build.VERSION.SDK_INT >= 24) {
                ...
                VectorDrawableCompat.createFromXmlInner(context.getResources(), parser, attrs, null)
            }
        } catch (e: Exception) {
...
//        val stringPool: Array<ByteArray> = BIN_XML_STRINGS
