...
import kotlinx.android.synthetic.main.dialog_bet_record_detail_list.img_close
...
class InfoCenterDetailDialog(val data:InfoCenterData):BaseDialog<InfoCenterViewModel>(InfoCenterViewModel::class) {

    @Suppress("UNREACHABLE_CODE")
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val binding:DialogInfoCenterDetailListBinding = DataBindingUtil.inflate(inflater, R.layout.dialog_info_center_detail_list,container,false)
        binding.apply {
