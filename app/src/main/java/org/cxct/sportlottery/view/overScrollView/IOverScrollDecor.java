...
public interface IOverScrollDecor {
    ...
    /**
     * Get the current decorator's runtime state, i.e. one of the values specified by {@link me.everything.android.ui.overscroll.IOverScrollState}.
     * @return The state.
     */
    int getCurrentState();
     ...
     * {@link #setOverScrollStateListener(me.everything.android.ui.overscroll.IOverScrollStateListener)}.</p>
     *
