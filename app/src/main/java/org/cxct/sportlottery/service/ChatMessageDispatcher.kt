...
object ChatMessageDispatcher {
    ...
    private val contentClazz = mapOf<Int, Class<*>>(
        ...
        ChatMsgReceiveType.CHAT_SEND_RED_ENVELOPE to ChatRedEnvelopeResult::class.java,
        ...
        ChatMsgReceiveType.CHAT_WIN_RED_ENVELOPE_ROOM_NOTIFY to ChatWinRedEnvelopeResult::class.java,
        ChatMsgReceiveType.CHAT_WIN_RED_ENVELOPE_RAIN_NOTIFY to ChatWinRedEnvelopeResult::class.java,
        ...
        ChatMsgReceiveType.CHAT_SEND_PERSONAL_RED_ENVELOPE to ChatPersonalRedEnvelopeResult::class.java,
        ...
        ChatMsgReceiveType.CHAT_MSG_RED_ENVELOPE to ChatRedEnvelopeMessageResult::class.java,
