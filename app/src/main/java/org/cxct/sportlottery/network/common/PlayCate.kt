...
enum class PlayCate(val value: String) {
    ...
    TT_ROSHANS_OU_MAP_1("TT-Roshans-O/U-MAP-1"),
    TT_ROSHANS_OU_MAP_2("TT-Roshans-O/U-MAP-2"),
    TT_ROSHANS_OU_MAP_3("TT-Roshans-O/U-MAP-3"),
    TT_TOWER_OU_MAP_1("TT-Tower-O/U-MAP-1"),
    TT_TOWER_OU_MAP_2("TT-Tower-O/U-MAP-2"),
    TT_TOWER_OU_MAP_3("TT-Tower-O/U-MAP-3"),
    ...
    companion object {
        ...
        fun needShowHomeAndAway(code: String?): Boolean {
            return when (code) {
                ...
                TT_ROSHANS_OU_MAP_1.value,
                TT_ROSHANS_OU_MAP_2.value,
                TT_ROSHANS_OU_MAP_3.value,
                TT_TOWER_OU_MAP_1.value,
                TT_TOWER_OU_MAP_2.value,
                TT_TOWER_OU_MAP_3.value,
