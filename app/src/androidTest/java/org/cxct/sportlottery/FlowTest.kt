...
//
//    //5.排序类
//    println("反序: list1.reversed():${list1.reversed()}")
//    println("升序:list1.sorted():${list1.sorted()}")
//    println("自定义排序: list1.sortedBy() : ${list1.sortedBy { it + 1 }}")
//    println("降序: list1.sortedDescending(): ${list1.sortedDescending()}")
//
////    try {
//        list1.single()
//    } catch (e: Exception) {
...
//    println("${"   ".isBlank()}")
    ...
    val lis1 =
        listOf<Int>(1, 2, 3, 5, 5, 6, 8, 784, 45, 46, 2, 45, 10, 2, 6, 56, 859, 89, 48, 12, 20)


    println("lis1.any: ${lis1.any { it == 100 }}")
    println("lis1.all: ${lis1.all { it < 10000 }}")
